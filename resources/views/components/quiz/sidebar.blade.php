            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route("to-dashboard") }}" 
                        ...
                        {{ $currentTab === 'dashboard' ? 'bg-[#DBEAFE] text-green-800' : 'text-slate-800 hover:bg-[#DBEAFE]' }}">
                ...
                <!-- My Quizzes -->
                <li>
                    <a href="{{ route("to-quiz-list") }}" 
                        class="menu-item text-[15px] font-medium flex items-center cursor-pointer rounded-md px-3 py-3 transition-all duration-300
                        {{ $currentTab === 'quizzes' ? 'bg-[#DBEAFE] text-green-800' : 'text-slate-800 hover:bg-[#DBEAFE]' }}">
