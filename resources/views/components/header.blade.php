...
<header class="flex shadow-md py-4 px-4 sm:px-10 bg-white min-h-[70px] tracking-wide relative z-50">
    ...
    <div class="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <a href="/" class="max-sm:hidden flex items-center shrink-0">
            <img src="{{ asset('img/logo.png') }}" alt="logo" class="h-14 w-auto object-contain" />
        </a>
        <a href="javascript:void(0)" class="hidden max-sm:flex items-center shrink-0">
            <img src="{{ asset('img/logo.png') }}" alt="logo" class="h-12 w-auto object-contain" />
        </a>
        
        <div id="collapseMenu"
            class="max-lg:hidden lg:flex lg:flex-1 lg:justify-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50">
            ...
            <div @class(['hidden' => $hideMenu,])>
                <ul 
                    ...
                    <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3 pl-26">
                        <a href="javascript:void(0)" class="hover:text-blue-700 text-blue-700 block font-medium text-[15px]">Home</a>
                    </li>
                    <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
                        <a href="javascript:void(0)" class="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Feature</a>
                    </li>
                    <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
                        <a href="javascript:void(0)" class="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">About</a>
                    </li>
                    <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
