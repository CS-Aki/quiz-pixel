        ...
        <nav id="sidebar" class="lg:min-w-[270px] w-max max-lg:min-w-8">
          <div id="sidebar-collapse-menu"
            ...
            <div class="pt-8 pb-2 px-6 sticky top-0 bg-white min-h-[80px] z-[100]">
              <a href="/" class="outline-0"><img src="{{ asset('img/logo.png') }}"
                ...
                <div class="flex items-center justify-end gap-6 ml-auto">
                  ...
                  <div class="dropdown-menu relative flex shrink-0 group">
                    <div class="flex items-center gap-4">
                      <p class="text-slate-500 text-sm">Hi, {{ Auth::user()->last_name }}</p>
...
@endif
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="text-[15px] text-slate-800 font-medium cursor-pointer flex items-center p-2 rounded-md hover:bg-[#d9f3ea] dropdown-item transition duration-300 ease-in-out w-full text-left">
                                
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                    class="w-[18px] h-[18px] mr-3 fill-current"
                                    viewBox="0 0 6 6">
                                    <path
    ...
    @if(!Auth::user()->password) 
        <div id="setPasswordModal" class="hidden fixed inset-0 z-[200] flex items-center justify-center">
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8 z-10">
                ...
                <!-- Form -->
                <form action="{{ route('profile.set-password') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="modalPassword"
                                ...
                                class="w-full px-4 py-2.5 pr-10 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition" />
                            <button type="button" onclick="toggleVisibility('modalPassword')"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="modalPasswordConfirm"
                                ...
                                class="w-full px-4 py-2.5 pr-10 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition" />
                            <button type="button" onclick="toggleVisibility('modalPasswordConfirm')"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                                ...
                            </button>
                        </div>
                    ...
                    <button type="button" id="savePasswordBtn"
                        class="w-full py-2.5 bg-[#00b074] hover:bg-[#009962] text-white text-sm font-semibold rounded-lg transition duration-300 mt-2">
                        Save Password
                    </button>
