    ...
    <div class="pt-10">
      <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
        <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-8">
          <h1 class="text-slate-900 md:text-5xl text-4xl font-bold !leading-tight">Elevate Your Experience with Modern Elegance</h1>
          <p class="text-slate-900 mt-6 text-base font-medium leading-relaxed">Our intuitive platform streamlines every aspect of your business operations. Effortlessly manage projects and automate workflows.</p>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 min-[1200px]:!grid-cols-4 gap-6 px-8 sm:px-12 my-12">
        <div class="bg-slate-200 p-6 rounded-md">
          ...
          <h3 class="text-lg font-semibold mb-2 text-slate-900">Customization</h3>
          <p class="text-base text-slate-600">Easily tailor every aspect of the platform to suit your needs.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block text-base mt-6 hover:underline">Learn more</a>
        </div>
        <div class="bg-slate-200 p-6 rounded-md">
          ...
          <h3 class="text-lg font-semibold mb-2 text-slate-900">Support</h3>
          <p class="text-base text-slate-600">24/7 customer support for all your inquiries.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block text-base mt-6 hover:underline">Learn more</a>
        </div>
        <div class="bg-slate-200 p-6 rounded-md">
          ...
          <h3 class="text-lg font-semibold mb-2 text-slate-900">Performance</h3>
          <p class="text-base text-slate-600">Experience blazing-fast performance with our product.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block text-base mt-6 hover:underline">Learn more</a>
        </div>
        <div class="bg-slate-200 p-6 rounded-md">
          ...
          <h3 class="text-lg font-semibold mb-2 text-slate-900">Security</h3>
          <p class="text-base text-slate-600">Your data is protected by the latest security measures.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-semibold inline-block text-base mt-6 hover:underline">Learn more</a>
        </div>
      </div>
    </div>
