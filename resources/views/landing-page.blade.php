<x-layout>
    <x-header :hideMenu="false"/>

    <div class="pt-10">
        <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">

            <!-- HERO LEFT -->
            <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-8">
                <h1 class="text-slate-900 md:text-5xl text-4xl font-bold !leading-tight">
                    Run Live Quizzes. Compete in Real Time.
                </h1>

                <p class="text-slate-900 mt-6 text-base font-medium leading-relaxed">
                    Create interactive quizzes, invite players with a simple room code, and track scores instantly with live leaderboards.
                    Perfect for classrooms, teams, and events.
                </p>

                <a href="/login" class="inline-block bg-slate-900 hover:bg-slate-800 text-white font-medium text-base rounded-md px-6 py-3 mt-8">
                    Get Started
                </a>
            </div>

            <!-- HERO IMAGE -->
            <div class="lg:h-[480px] h-full flex items-center">
                <img src="https://readymadeui.com/team-image.webp" class="w-full h-full object-cover" alt="Quiz Platform" />
            </div>
        </div>

        <!-- FEATURES -->
        <div class="px-8 sm:px-12 my-12">
            <h2 class="text-3xl font-bold text-slate-900 text-center mb-8">
                Features
            </h2>

            <div class="grid sm:grid-cols-2 lg:grid-cols-3 min-[1200px]:!grid-cols-4 gap-6">

                <!-- QUIZ BUILDER -->
                <div class="bg-slate-200 p-6 rounded-md hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Quiz Builder</h3>
                    <p class="text-base text-slate-600">
                        Create quizzes effortlessly with flexible question types and formats for any audience.
                    </p>
                </div>
                ...
                <div class="bg-slate-200 p-6 rounded-md hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Multiplayer Rooms</h3>
                    <p class="text-base text-slate-600">
                        Launch live quiz sessions with a simple room code so players can join and compete instantly.
                    </p>
                </div>
                ...
                <div class="bg-slate-200 p-6 rounded-md hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Live Leaderboards</h3>
                    <p class="text-base text-slate-600">
                        Keep the competition exciting with real-time score updates and dynamic rankings.
                    </p>
                </div>
                ...
                <div class="bg-slate-200 p-6 rounded-md hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Analytics & Reports</h3>
                    <p class="text-base text-slate-600">
                        Review detailed quiz statistics, player rankings, and export results for deeper insights.
                    </p>
                </div>
        ...
        <!-- HOW IT WORKS -->
        <div class="px-8 sm:px-12 my-12">
            <h2 class="text-3xl font-bold text-slate-900 text-center mb-8">How It Works</h2>

            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-slate-200 p-6 rounded-md text-center">
                    <div class="w-12 h-12 mx-auto mb-4 rounded-full bg-blue-600 text-white flex items-center justify-center text-lg font-bold">
                        1
                    </div>
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Create</h3>
                    <p class="text-base text-slate-600">
                ...
                <div class="bg-slate-200 p-6 rounded-md text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Share</h3>
                    <p class="text-base text-slate-600">
                        Invite players instantly using a room code.
                    </p>
                </div>
                ...
                <div class="bg-slate-200 p-6 rounded-md text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Play</h3>
                    <p class="text-base text-slate-600">
                        Participants join and compete live in real time.
                    </p>
                </div>
                ...
                <div class="bg-slate-200 p-6 rounded-md text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2 text-slate-900">Analyze</h3>
                    <p class="text-base text-slate-600">
                        Review results, rankings, and performance instantly.
                    </p>
                </div>
            </div>
        </div>
